    ...
    datasets: [
      {
        label: "Ganancia",
        lineTension: 0,
        backgroundColor: "rgba(254,94, 96, 0.05)",
        borderColor: "rgba(254,94, 96, 1)",
        pointRadius: 3,
        pointBackgroundColor: "rgba(254,94, 96, 1)",
        pointBorderColor: "rgba(254,94, 96, 1)",
        pointHoverRadius: 3,
        pointHoverBackgroundColor: "rgba(254,94, 96, 1)",
        pointHoverBorderColor: "rgba(254,94, 96, 1)",
        pointHitRadius: 10,
        pointBorderWidth: 2,
        data: [
          Enero,
